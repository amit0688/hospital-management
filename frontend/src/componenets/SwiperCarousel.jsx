...
export const SwipeCarousel = ({ user }) => {
  const { images } = user; // Accessing images array from user prop
      ...
      {images.map((imgSrc, idx) => {
        return (
          <motion.div
            ...
            transition={SPRING_OPTIONS}
            className=" w-[300px] h-[300px] rounded-xl bg-neutral-800 object-cover"
          />
        );
      })}
    </>
